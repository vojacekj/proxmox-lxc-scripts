...
HEADER
    ...
    for fn in normalize_url lookup_service get_icon_url get_port_override get_service_group homepage_icon link_host extract_service_names merge_homepage_yaml extract_endpoint_names merge_gatus_yaml new_service_names new_endpoint_names; do
